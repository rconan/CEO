...
CYTHON_DIR	= utilities source imaging centroiding shackHartmann atmosphere BTBT iterativeSolvers LMMSE aaStats rayTracing gmtMirrors segmentPistonSensor pyramid
