...
SOURCE_DIR	= utilities source atmosphere imaging centroiding shackHartmann aaStats BTBT GBTBT iterativeSolvers plotly rayTracing gmtMirrors segmentPistonSensor pyramid
TUTORIAL	= ngsao lgsao ltao ltaoVsAst geaos
CYTHON_DIR	= utilities source imaging centroiding shackHartmann atmosphere BTBT GBTBT iterativeSolvers aaStats rayTracing gmtMirrors segmentPistonSensor pyramid
