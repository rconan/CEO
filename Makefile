...
CYTHON_DIR	= utilities source imaging centroiding shackHartmann atmosphere iterativeSolvers LMMSE aaStats rayTracing gmtMirrors segmentPistonSensor pyramid
